                        ...
                        <div className="hexagon-img">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                ...
                                <defs>
                                    ...
                                    <image id="images" width="1584.46" height="753.059"
                                        xlinkHref={idea} />
                                </defs>
                                <g transform="translate(57.332 48.932)">
                                    ...
                                    <g className="clsh-4" transform="translate(0.001 0)">
                                        <use transform="translate(-365.03 56.54)" xlinkHref="#images" />
                                    </g>
                                    <g className="clsh-5" transform="translate(91.493 85.392)">
                                        <use transform="translate(-456.522 -28.851)" xlinkHref="#images" />
                                    </g>
                                </g>
                            </svg>
                        </div>
